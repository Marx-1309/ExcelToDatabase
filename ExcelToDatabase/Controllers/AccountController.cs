...
using HrGpIntegration.Models.ViewModel;
using HrGpIntegration.SD;
...
namespace HrGpIntegration.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            if (!_roleManager.RoleExistsAsync(HrGpIntegration.SD.SD.Admin).GetAwaiter().GetResult())
            {
                await _roleManager.CreateAsync(new IdentityRole(HrGpIntegration.SD.SD.Admin));
                await _roleManager.CreateAsync(new IdentityRole(HrGpIntegration.SD.SD.User));
            }
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnurl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //else
                    //{
                    //    await _userManager.AddToRoleAsync(user, HrGpIntegration.SD.SD.User);
                    //}
